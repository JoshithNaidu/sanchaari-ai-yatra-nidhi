...
const FloatingChatbot = () => {
  ...
  // Desktop View (Smaller Right Sidebar)
      ...
      {isOpen && (
        <div className="fixed right-0 top-0 h-full w-80 bg-white shadow-2xl border-l border-gray-200 z-50 flex flex-col">
          ...
          <div className="bg-blue-600 text-white p-3 flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-sm">Sanchaari AI</h3>
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-3">
            ...
            {isTyping && (
              <div className="flex justify-start">
                <div className="bg-gray-100 text-gray-800 px-3 py-2 rounded-lg max-w-[85%]">
