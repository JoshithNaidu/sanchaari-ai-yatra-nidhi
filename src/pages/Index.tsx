      ...
      <section className="py-16 bg-brand-soft-gray">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-brand-charcoal mb-4">What Our Travelers Say</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-brand-soft-gray">
              <div className="flex items-center gap-4 mb-4">
                ...
                />
                <div>
                  <h4 className="font-semibold text-brand-charcoal">Priya Sharma</h4>
                  <span className="inline-block bg-brand-accent-aqua text-white text-xs px-2 py-1 rounded">India</span>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-brand-soft-gray">
              <div className="flex items-center gap-4 mb-4">
                ...
                />
                <div>
                  <h4 className="font-semibold text-brand-charcoal">Rajesh Kumar</h4>
                  <span className="inline-block bg-brand-accent-aqua text-white text-xs px-2 py-1 rounded">India</span>
                </div>
              </div>
              <p className="text-brand-charcoal/70">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-brand-soft-gray">
              <div className="flex items-center gap-4 mb-4">
                ...
                />
                <div>
                  <h4 className="font-semibold text-brand-charcoal">Sneha Patel</h4>
                  <span className="inline-block bg-brand-accent-aqua text-white text-xs px-2 py-1 rounded">India</span>
                </div>
              </div>
              <p className="text-brand-charcoal/70">
          ...
          <div className="text-center">
            <a 
              href="/reviews" 
              className="inline-block bg-brand-accent-aqua text-white px-8 py-3 rounded-lg hover:bg-brand-sky-blue transition-colors"
            >
              Read All Reviews
            </a>
          </div>
